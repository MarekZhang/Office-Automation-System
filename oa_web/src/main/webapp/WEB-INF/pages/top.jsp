...
<head>
    ...
    <title> Mini OA--Welcome to Mini OA System </title>
    ...
    <aside id="sidebar_left" class="nano nano-light affix">
        <div class="sidebar-left-content nano-content">
            ...
            <ul class="nav sidebar-menu">
                <li class="sidebar-label pt20">Daily Management</li>
                <li>
                    <a href="/claim_voucher/deal">
                        <span class="glyphicon glyphicon-book"></span>
                        <span class="sidebar-title">Pending Expenses Claim Sheet</span>
                ...
                <li class="active">
                    <a href="/claim_voucher/self">
                        ...
                        <span class="sidebar-title">Personal Expense Claim Sheet</span>
                    </a>
                </li>
                <li>
                    <a href="/claim_voucher/to_add">
                        <span class="fa fa-calendar"></span>
                        <span class="sidebar-title">Start a new Sheet</span>
                    </a>
                </li>
                <li class="sidebar-label pt15">Basic Information</li>
                <li>
                    <a class="accordion-toggle" href="#">
                        <span class="glyphicon glyphicon-check"></span>
                        <span class="sidebar-title">Staff Management</span>
                        <span class="caret"></span>
                    </a>
                    <ul class="nav sub-nav">
                        <li>
                            <a href="/employee/list">
                                <span class="glyphicon glyphicon-calendar"></span> Staff List </a>
                        </li>
                        <li class="active">
                            <a href="/employee/to_add">
                                <span class="glyphicon glyphicon-check"></span> Add new Staff </a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav sub-nav">
                        ...
                        <li class="active">
                            <a href="/department/to_add">
                                <span class="glyphicon glyphicon-check"></span> Add Department </a>
                        </li>
                    </ul>
                </li>
            </ul>
